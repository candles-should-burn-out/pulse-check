...
- Поддержать будущую модель приглашенных участников: они помогают собирать статистику по статусам, а руководитель видит агрегаты без конкретных сущностей.
...
| Participant              | Участник, который может участвовать в сборе статистики по статусам без раскрытия конкретных сущностей руководителю.  |
